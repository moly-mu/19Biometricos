...
const ReporteAsistencia = () => {
    ...
    return (
        ...
        <main className="report-repA">
            <h2 className="titu--repA">Reporte de Asistencia</h2>
            ...
            {cargando ? (
                <p className="carga-datos-repA">Cargando datos...</p>
            ) : error ? (
                <p className="error">{error}</p>
            ) : (
                <div className="datos-repA">
                    <table className="tabla-datos-repA">
                        <thead className="thr-repA">
                            <tr>
                        ...
                        <tbody>
                            {registros.length > 0 ? (
                                ...
                                <tr>
                                    <td colSpan="4" className="td-repA">
